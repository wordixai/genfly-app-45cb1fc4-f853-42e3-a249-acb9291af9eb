              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-[1rem] grid grid-cols-5 gap-x-3 gap-y-1 scale-105 z-10">
                  ...
                  {Array.from({ length: 25 }).map((_, i) => (
                    <div
                      key={i}
                      className="size-9 transform hover:scale-110 hover:brightness-110 transition-all duration-500 ease-out animate-float"
                      style={{
                        animationDelay: `${i * 150}ms`,
                        opacity: 0.85,
                        transform: i % 5 === 0 ? 'translateX(36px)' : 'translateX(0)'
                      }}
                    >
                      <div className="flex items-center justify-center size-6 flex-shrink-0 rounded-full border border-border/50 shadow bg-muted p-0.5">
                        <div className="overflow-hidden rounded-full">
                          <img
                            ...
                            height="256"
                            alt="Provider"
                            src={`https://openrouter.ai/images/icons/${
                              ['Microsoft', 'Perplexity', 'GoogleGemini', 'OpenAI', 'Anthropic'][i % 5]
                            }.svg`}
              ...
              <div className="h-full flex items-center justify-center">
                <div className="relative w-full max-w-52 flex flex-col items-center gap-y-2">
                  ...
                  <div className="flex justify-between w-full">
                    ...
                    <div className="flex items-center justify-center size-6 flex-shrink-0 rounded-full border border-border/50 shadow bg-muted p-0.5">
                      <img width="256" height="256" alt="Amazon" src="https://openrouter.ai/images/icons/Bedrock.svg" className="h-full w-full object-cover" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-background shadow-none transition-transform group-hover/card:scale-105 group-hover/card:-translate-y-1 relative h-48 overflow-hidden rounded-t-xl border-b p-2 flex-shrink-0">
              <div className="h-full flex items-center justify-center">
                <div className="flex flex-col items-center w-full max-w-52">
                  ...
                  <svg className="size-32 text-muted-foreground/60" fill="none" stroke="currentColor" strokeWidth="0.3" viewBox="0 0 24 24">
